...
cartItemsContainer.addEventListener("click", function(event){
 ...
 checkoutBtn.addEventListener("click", function(){
    ...
    const isOpen = checkRestrauranteOpen();
 ...
 function checkRestrauranteOpen(){
    const data = new Date();
